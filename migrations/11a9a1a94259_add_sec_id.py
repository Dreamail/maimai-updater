...
def downgrade_maimai_updater() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('maimai_updater_user',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('user_id', sa.VARCHAR(), nullable=False),
    sa.Column('friend_id', sa.VARCHAR(), nullable=False),
    sa.Column('df_token', sa.VARCHAR(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_maimai_updater_user')
    )
    op.create_table('maimai_updater_token',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('token', sa.VARCHAR(), nullable=False),
    sa.Column('userid', sa.VARCHAR(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_maimai_updater_token')
    )
    # ### end Alembic commands ###
